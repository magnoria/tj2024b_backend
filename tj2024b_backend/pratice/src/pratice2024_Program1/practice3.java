				...
				if (choose == 1) {System.out.println("저장을 선택하셨습니다");
					...
					System.out.print("작성자:"); String writer = scan.next();
						...
						if (subject1 == null) { subject1 = title; content1 = content; writer1 = writer;
								...
								subject2 = title; content2 = content; writer2 = writer;
							}else if (subject3 == null) {
								subject3 = title; content3 = content; writer3 = writer;
							}else {
					...
					if (subject1 != null) {System.out.println("제목:" + subject1 + "내용:" + content1 + "작성자:" + writer1);
						...
						}else if (subject2 != null) {System.out.println("제목:" + subject2 + "내용:" + content2 + "작성자:" + writer2 );
						
						}else if (subject3 != null) {System.out.println("제목:"+subject3 + "내용:" + content3 + "작성자:" +writer3);
