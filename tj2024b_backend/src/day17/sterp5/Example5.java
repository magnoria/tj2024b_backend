...
interface InterFaceTest2{
	...
	//2. 추상메소드 : 선언부(함수의 접근제한자 반환타입 메소드명 매개변수)만 작성
	public abstract void method();//{}중괄호가 없다.
	// + jdk 1.5 이상부터 추가된 메소드 
	//3. 디폴트메소드
	public default void method2() {} // 인터페이스에 구현한 멘소드를 만들 수 있다.
	//4. 정적 메소드
	...
	//6. private 정적 메소드
	 ...
	 //+ : static 이란? 프로그램이 시작될때 메모리가 할당 되고 프로그램이 끝날때 메모리가 초기화.
	 	// - static 이 있는 변수 또는 메소드는 인스턴스가 없어도 사용이 가능하다.
...
public class Example5 {
	public static void main(String[] args) {
			...
			//[3] 인터페이스의 디폴트 메소드 호출, X
			//InterFaceTest2.method2();
			
			//[4] 인터페이스의 정적메소드 호출, O
			InterFaceTest2.method3();
			
			//[*] 인터페이스타입은 new 할수없다. 즉] 인스턴스 생성 불가능
