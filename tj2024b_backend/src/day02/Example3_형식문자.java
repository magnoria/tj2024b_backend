	...
	public static void main(String[] args) { //main start
		...
		System.out.println();
			...
			/*
			 ...
			 %d : 정수  , %f :실수
			 [자리수 맞추기]
			 %자릿수d : 자릿수만큼 자릿수 차지, 만일 비어 있으면 공백처리 , 오른쪽 정렬 
			 %-자릿수d : 자릿수만큼 자릿수 차지, 만일 비어 있으면 공백처리, 왼쪽정렬
			 %0자릿수d : 자릿수만큼 자릿수차지, 만일 비어 있으면 '0'처리
			 [소수점 자릿수 맞추기]
